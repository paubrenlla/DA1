...
VALUES
  ('Auto Rojo',          'Vehículo',          'Auto eléctrico de la flota',           0, 1, 0),
  ('Laptop Desarrollo',  'Equipo Electrónico','Computadora para desarrolladores',     1, 5, 0),

...
public class UsuarioTests
{
    ...
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario(null, "Nombre", "Apellido", "EsValida1!", new DateTime(2000, 1, 1)));
    }

    [TestMethod]
    public void ConstructorUsuarioEmailVacio_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("", "Nombre", "Apellido", "EsValida1!", new DateTime(2000, 1, 1)));
    }
    
    [TestMethod]
    public void ConstructorUsuarioNombreVacio_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("example@email.com", "", "Apellido", "EsValida1!", new DateTime(2000, 1, 1)));
    }
    
    [TestMethod]
    public void ConstructorUsuarioNombreNulo_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("example@email.com", null, "Apellido", "EsValida1!", new DateTime(2000, 1, 1)));
    }

    [TestMethod]
    public void ConstructorUsuarioApellidoVacio_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("example@email.com", "Nombre", "", "EsValida1!", new DateTime(2000, 1, 1)));
    }
    
    [TestMethod]
    public void ConstructorUsuarioApellidoNulo_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("example@email.com", "Nombre", null, "EsValida1!", new DateTime(2000, 1, 1)));
    }
    
    [TestMethod]
    public void ConstructorUsuarioContraseñaVacia_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("example@email.com", "Nombre", "Apellido", "", new DateTime(2000, 1, 1)));
    }
    
    [TestMethod]
    public void ConstructorUsuarioContraseñaNula_LanzaArgumentException()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new Usuario("example@email.com", "Nombre", "Apellido", null, new DateTime(2000, 1, 1)));
    }
    ...
    {
        Assert.ThrowsException<ArgumentException>(() => new Usuario("example@email.com", "Nombre", "Apellido", "EsValida1!", DateTime.Now.AddYears(1)));
    }
